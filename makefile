...
$(TARGET): ebcscrip.o trnsunit.o parser.o decl.o expr.o init.o stmt.o parse.tab.o lex.yy.o name.o code.o hashmap.o btree.o slist.o
	$(AR) $(ARFLAGS) $@ $?
...
stmt.o: stmt.c stmt.h parser.h name.h slist.h
	$(CC) $(CFLAGS) $<
...
clean:
	$(RM) $(TARGET)
	$(RM) ebcscrip.o trnsunit.o parser.o decl.o expr.o init.o stmt.o parse.tab.o lex.yy.o name.o code.o hashmap.o btree.o slist.o
